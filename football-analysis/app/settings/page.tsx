    ...
    <div className="flex flex-1 flex-col px-4 pt-[calc(1.25rem+env(safe-area-inset-top))] pb-6">
      ...
      <section className="mt-6 rounded-2xl border border-border-subtle bg-surface p-4">
        ...
        <ol className="mt-2 flex flex-col gap-2 text-xs leading-relaxed text-text-secondary">
          ...
          <li>
            ...
            โดยกันบิลซ้ำทิศทางออก (เช่น เต็ง + ต่อทีมเดียวกัน = ความเห็นเดียวกันสองบิล จะเลือกเส้นที่ดีที่สุดให้เส้นเดียว)
          </li>
          <li>
            <span className="font-medium text-text-primary">5. อ่านการไหลของราคา</span> — เทียบราคาเปิดกับราคาปัจจุบัน
            ถ้าราคาไหลเข้าทางบิล (เงินฉลาดเห็นตรงกัน) ความมั่นใจเพิ่ม ไหลสวนทางความมั่นใจลด
          </li>
          <li>
            <span className="font-medium text-text-primary">6. แนะนำขนาดเดิมพัน</span> — คำนวณด้วยสูตร Kelly แบบระวัง
            (เศษหนึ่งส่วนสี่ของ Kelly เต็ม, เพดาน 2u) — edge ใหญ่แทงมากขึ้น edge เล็กแทงน้อยลง ไม่ใช่แทงเท่ากันทุกบิล
          </li>
        </ol>
      </section>
      ...
      <section className="mt-4 rounded-2xl border border-info/30 bg-info/10 p-4">
        ...
        <p className="mt-2 text-xs leading-relaxed text-text-secondary">
          ...
          การเทียบราคาข้ามเจ้ามือเพื่อได้ราคาน้ำที่ดีที่สุด บวกกับจุดที่โมเดลเราต่างจากตลาด.
          หน้าสถิติวัดผลด้วย CLV (เทียบราคาที่แนะนำกับราคาปิดตลาด) — ตัวชี้วัดที่ซื่อสัตย์ที่สุดว่าระบบมีสัญญาณจริงหรือแค่ดวง.
          เล่นอย่างมีสติและบริหารเงินเสมอ
        </p>
      </section>
