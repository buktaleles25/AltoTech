...
const TH = {
  ...
  bgRemove: 'ลบพื้นหลังอัตโนมัติ (AI)',
  bgRemoveHint: 'ประมวลผลบนเครื่อง 100% · โหลดโมเดลครั้งแรกครั้งเดียว (ฟรี)',
  bgModelLoading: 'กำลังโหลดโมเดล AI…',
  bgRemoving: 'กำลังลบพื้นหลัง…',
  bgNewLabel: 'พื้นหลังใหม่',
  bgTransparent: 'โปร่งใส',
  bgColor: 'สีพื้น',
  bgImage: 'รูป',
  bgTransparentPng: 'โปร่งใส = เซฟเป็น PNG อัตโนมัติ ✨',
  bgPastel: 'พาสเทล',
  bgStudio: 'สตูดิโอ',
  bgUpload: 'อัปโหลดพื้นหลังเอง',
  bgSpeedNote: 'ครั้งแรกต้องโหลดโมเดล; บางเครื่องอาจใช้เวลาสักครู่ต่อรูป',
  bgModelFailed: 'โหลดโมเดล AI ไม่สำเร็จ (ครั้งแรกต้องต่อเน็ต)',
...
const EN: typeof TH = {
  ...
  bgRemove: 'Auto-remove background (AI)',
  bgRemoveHint: '100% on-device · one-time model download (free)',
  bgModelLoading: 'Loading AI model…',
  bgRemoving: 'Removing background…',
  bgNewLabel: 'New background',
  bgTransparent: 'Transparent',
  bgColor: 'Color',
  bgImage: 'Image',
  bgTransparentPng: 'Transparent = auto-saved as PNG ✨',
  bgPastel: 'Pastel',
  bgStudio: 'Studio',
  bgUpload: 'Upload background',
  bgSpeedNote: 'First run downloads the model; may take a moment per photo on some devices',
  bgModelFailed: 'Failed to load AI model (needs internet on first run)',
